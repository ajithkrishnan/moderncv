...
{
\begin{itemize}
\item Designed and implemented MLP to estimate Odometry of a vehicle using Keras.
...
\cvitem{\fontsize{9}{10.8}\selectfont{Advanced}}{Python, Tensorflow, Keras, Robotic Operating System(ROS), Linux OS}
\cvitem{\fontsize{9}{10.8}\selectfont{Intermediate}}{C++, Unity3D, Unreal Engine, Matlab Simulink\newpage}
