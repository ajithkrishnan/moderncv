...
\newcommand{\institute}{Institute for Data Science in Mechanical Engineering\hspace{1mm}}
\newcommand{\position}{Research Assistant\hspace{1mm}}
\newcommand{\applicationnr}{32206}
...
\newcommand{\tofill}{\textbf{{\color{red}...........}}\hspace{1mm}}
...
My name is Ajith Krishnan and while I have a strong background in \tofill and experience with \tofill  it is the opportunity to 
work as \position at \institute that excites me. \tofill. I have always wanted to work on projects on \tofill and have a passion 
for guiding projects to completion.

I have completed my masters in Mechatronics from FH Aachen. During my course I have gained experience implementing various model-based and 
...
having worked with these systems on a daily basis as Student Assistant at Streetscooter GmbH. Additionally I have extensive experience with the Robotic Operative System (ROS) software stack 
and the Linux OS.
...
and finally analyzing their performances on evaluation data. I am also experienced in object oriented design from developing various packages and libraries 
in both Python and C++ languages.
...
I only request you to provide me a chance to showcase my drive.
...
\cvitem{\fontsize{9}{10.8}\selectfont{Advanced}}{Robotic Operating Software(ROS)}
%\cvitem{\fontsize{9}{10.8}\selectfont{Intermediate}}{Matlab/SIMULINK}
