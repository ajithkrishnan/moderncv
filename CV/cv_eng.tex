...
\httplink{github.com/ajithkrishnan/agv}


I had modified these existing networks to run on custom training and 
test datasets at Streetscooter GmbH.

-  vid2depth: \httplink{gitlab.com/ajithkrishnan/models/tree/master/research/vid2depth}

- SfMLearner: \httplink{gitlab.com/ajithkrishnan/sfmlearner}


These are some of the Docker Images i had created to work on various projects.

- Docker Images: \httplink{github.com/ajithkrishnan/Docker} 
...
{
\begin{itemize}
\item Developed and designed simulations of autonomous vehicles in Unity 3D and Unreal Engine.
\item Implemented indoor/outdoor SLAM systems using RGBD and Monocular cameras.    
\newline{}
\end{itemize}
}
...
\cvitem{\fontsize{9}{10.8}\selectfont{Advanced}}{Python, Tensorflow, Keras, Matlab Simulink, Robotic Operating System(ROS), Gazebo}
\cvitem{\fontsize{9}{10.8}\selectfont{Intermediate}}{C++/C, SolidWorks, AutoCAD\newpage}
